...
class ShapeBuilder {
    ...
    private fun setSelectorColor(gradientDrawable: GradientDrawable, state: Int) {
        if (useSelector && state != 0) {
            when (state) {
                R.attr.state_pressed -> gradientDrawable.setColor(selectorPressedColor)
                -R.attr.state_enabled -> gradientDrawable.setColor(selectorDisableColor)
                R.attr.state_enabled -> gradientDrawable.setColor(selectorNormalColor)
            }
        }
    }
    ...
    private val selectorDrawable: StateListDrawable
        get() {
            ...
            stateListDrawable.addState(intArrayOf(R.attr.state_pressed, R.attr.state_enabled), getDrawable(R.attr.state_pressed))
            stateListDrawable.addState(intArrayOf(-R.attr.state_enabled), getDrawable(-R.attr.state_enabled))
            stateListDrawable.addState(intArrayOf(), getDrawable(R.attr.state_enabled))
            return stateListDrawable
        }
